...
<body>
    <div>
                ...
                <tr>
                    ...
                    <td width="86" align="right">
                        <a href="https://www.mgu.ac.in/">
                            <img src="<?= base_url('images/mgulogo.png'); ?>" width="300" height="90" style="margin-top: 15px;" />
                        </a>
                    </td>
        ...
        <div style="height: 600px;">
            ...
            <table align="center" cellpadding="0" cellspacing="0" border="0" width="95%" class="main_table" height="580px">
                <tr>

                    <td width="20%" bgcolor="#FFFFFF" class="ash_bordr" valign="top" align="left"><?= $this->renderSection('span1') ?></td>
                    <td width="1%"></td>
                    <td width="58%"  bgcolor="#FFFFFF" class="ash_bordr" valign="top" align="left"><?= $this->renderSection('span2') ?></td>
                    <td width="1%"></td>
                    <td width="20%" bgcolor="#FFFFFF" class="ash_bordr" valign="top" align="left"><?= $this->renderSection('span3') ?></td>
                </tr>
            </table>
        </div>
        <div style="height:10px;"></div>
